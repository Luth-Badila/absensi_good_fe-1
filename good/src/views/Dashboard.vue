  ...
  <div class="dashboard p-4">
    ...
    <div class="wrapper-card grid lg:grid-cols-4 grid-cols-1 md:grid-cols-2 gap-2 mt-5">
      ...
      <!-- <div class="card bg-white dark:bg-gray-800 w-full rounded-md p-5 shadow flex">
        <div class="p-2 max-w-sm">
          <div class="bg-red-200 rounded-full w-14 h-14 text-lg p-3 text-red-600 mx-auto">
            <span class="">
              <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="30px" height="30px" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32">
      ...
      <!-- <div class="card bg-white dark:bg-gray-800 w-full rounded-md p-5 shadow flex">
        ...
        <div class="block p-2 w-full">
          <p class="font-semibold text-gray-900 dark:text-gray-200 text-xl">7 230</p>
    ...
    <!-- <div class="mt-2 lg:flex block lg:gap-2">
      ...
      <div class="bg-white dark:bg-gray-800 p-5 w-full rounded-md box-border shadow">
        <h2 class="font-bold text-lg text-gray-800 dark:text-gray-200">Total Sales</h2>
        ...
        <div class="wrapper-button mt-3">
          <select name="" id="" class="dark:bg-gray-800 dark:hover:bg-gray-700 border-gray-200 dark:border-gray-300 border max-w-lg px-4 py-3 block rounded-md text-gray-500 dark:text-gray-400">
            <option value="">Last 7 years</option>
          </select>
          <button class="uppercase float-right -mt-7 border-b border-red-600 text-red-600">Sales Report</button>
        </div>
      </div>
      <div class="bg-white dark:bg-gray-800 p-5 lg:w-96 lg:mt-0 mt-4 shadow rounded-md w-full">
        <h2 class="dark:text-gray-200 text-xl font-bold">Daftar User</h2>
        <p class="text-gray-400">Yang terakhir Absensi</p>
        <p class="font-medium font-lg mt-5 dark:text-gray-200">PT A</p>
        <div class="mt-4 grid grid-cols-1 gap-4">
          <button-list :buttons="buttonItems"></button-list>
        </div>
        <div class="mt-4 grid grid-cols-1 gap-4">
          <p class="font-medium font-lg mt-5 dark:text-gray-200">PT B</p>
    ...
    <!-- <div class="mt-2 lg:flex block lg:gap-2">
      <div class="mt-2 bg-white dark:bg-gray-800 p-5 w-full rounded-md box-border shadow">
        <h2 class="font-bold text-lg text-gray-800 dark:text-gray-200">1,780</h2>
        <p class="text-gray-400 font-lexend font-normal">New products this week</p>
        <span class="float-right">
          <h2 class="text-green-500 -mt-12 flex">
        ...
        <div class="wrapper-chart mt-5">
          ...
          <div class="wrapper-button mt-3">
            ...
            <button class="uppercase float-right -mt-7 border-b border-red-600 text-red-600">Product Report</button>
          </div>
        </div>
      </div>
      <div class="mt-2 bg-white dark:bg-gray-800 p-5 w-full rounded-md box-border shadow">
        ...
        <div class="wrapper-chart mt-5">
          ...
          <div class="wrapper-button mt-3">
            ...
            <button class="uppercase float-right -mt-7 border-b border-red-600 text-red-600">Vistor Report</button>
          </div>
        </div>
      </div>
      <div class="mt-2 bg-white dark:bg-gray-800 p-5 w-full rounded-md box-border shadow">
        ...
        <div class="wrapper-chart mt-5">
          ...
          <div class="wrapper-button mt-3">
            ...
            <button class="uppercase float-right -mt-7 border-b border-red-600 text-red-600">User Report</button>
          </div>
        </div>
      </div>
    </div> -->
    ...
    <!-- <div class="mt-2 bg-white dark:bg-gray-800 p-5 w-full rounded-md box-border shadow">
      ...
      <div class="wrapper-button mt-3">
        ...
        <button class="uppercase float-right -mt-7 border-b border-red-600 text-red-600">Transaction Report</button>
      </div>
    </div> -->
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      buttonItems: [{ label: "Pegawai 1" }, { label: "Pegawai 2" }, { label: "Pegawai 3" }],
      optionsArea: {
        xaxis: {
