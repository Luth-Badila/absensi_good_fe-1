<template>
  ...
  <nav class="sidebar bg-white dark:bg-gray-800">
    ...
    <div class="sidebar-list p-4 mt-4">
      ...
      <!-- <p class="font-medium text-gray-400 mt-4 dark:text-gray-600">UI Form & Tables</p> -->
      ...
      <div class="item mt-3">
        <router-link to="/">
          <button class="text-gray-800 dark:text-gray-500 bg-transparent hover:bg-gray-100 dark:hover:bg-gray-700 w-full flex text-left rounded-md box-border p-3">
